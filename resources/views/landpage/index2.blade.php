<!DOCTYPE html><html><head><meta charset="utf-8"/>
    ...
    {{-- <link href="resources/css/style.css" rel="stylesheet"/> --}}
      <link href="resources/css/landpage/css/style.css" rel="stylesheet"/> 
      <link href="resources/css/landpage/css/fullcalendar.css" rel="stylesheet"/> 
      <link href="resources/css/landpage/css/bootstrap.css" rel="stylesheet"/>
      
    <!-- responsive style -->
    {{-- <link href="resources/css/responsive.css" rel="stylesheet"/> --}}
      <link href="resources/css/landpage/css/responsive.css" rel="stylesheet"/> 
                ...
                <div class="row">
                      ...
                      <div class="btn-box">
                        @auth
                          <a href="{{ route('dashboard') }}" class="btn-1">
                            <img src="public/images/search-icon.png" width="22px" height="22px" alt="">
                            Browse Books
                          </a> 
                  ...
                  <div class="col-md-6">
                    <div class="slider_img-box">
                      <img src="public/images/slider_4.jpg" alt=""/>
            ...
            <div class="carousel-item">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="slider_img-box">
                      <img src="public/images/slider_2.jpg" alt=""/>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="carousel-item">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="slider_img-box">
                      <img src="public/images/slider_3.jpg" alt=""/>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="detail-box">
            ...
            <div>
              ...
              <a href="https://www.facebook.com/Zamboangacitylibrary" target="_blank">
                <img src="public/images/fb.png" width="22px" height="22px" alt="">
                Visit FB page
              </a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="service_container layout_padding2">
          <div class="service_box">
            <div class="img-box">
              <img src="public/images/ss-1.jpg" alt=""/>
            </div>
            <div class="detail-box">
              <h4>
                Online <br/>
          ...
          <div class="service_box">
            <div class="img-box">
              <img src="public/images/ss-2.jpg" alt=""/>
            </div>
            <div class="detail-box">
              <h4>
                Borrowing <br/>
