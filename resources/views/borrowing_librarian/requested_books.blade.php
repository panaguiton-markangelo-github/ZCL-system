<x-blibrarian-layout>
    ...
    <div class="p-6 mt-2 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1" style="white-space: nowrap">
        ...
        <div class="flex flex-col">
            ...
                            <th scope="col" class="text-sm font-medium  dark:text-gray-900 px-6 py-4 text-left">Book Title</th>
                            <th scope="col" class="text-sm font-medium  dark:text-gray-900 px-6 py-4 text-left">Borrower's First Name</th>
                            <th scope="col" class="text-sm font-medium  dark:text-gray-900 px-6 py-4 text-left">Borrower's Last Name</th>            
